        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
					<center><strong><span style="font-size: 15px;">Login: <?php echo $user; ?></span></strong></center>
                </div> 
				</div>
    ...
    <div class="modal fade" id="account" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Bekor qilish</button>
                    <button type="submit" class="btn btn-success"><span class="glyphicon glyphicon-check"></span> Yuklash</button>
				</form>
                </div>
            </div>
            <!-- /.modal-content -->
